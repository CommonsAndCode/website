...
Unsere Leitidee: **Digitale Gemeingüter („Commons“) und offene Technologien („Code“) sind die Grundlage einer demokratischen, souveränen, nachhaltigen und inklusiven Gesellschaft.**

Commons & Code steht für eine digitale Transformation, die:

- **Macht dezentralisiert** statt in wenigen Tech-Konzernen konzentriert

- **Klimaneutralität vorantreibt** statt Ressourcenverschwendung zu fördern

- **Demokratische Teilhabe ermöglicht** statt Manipulation und Überwachung

- **Europäische Werte verwirklicht** – vor allem dort, wo Politik den Menschen am nächsten ist: in den Kommunen
...
**Commons**: Wir setzen uns für **digitale Gemeingüter** ein. Das bedeutet: Open-Source-Software für die Verwaltung, offene Daten (Open Data) für mehr Transparenz, freier Zugang zu Wissen und die Stärkung digitaler Bürgerrechte. Technologie muss dem Menschen dienen, nicht umgekehrt.
...
**Digitale Souveränität**: Systematischer Aufbau europäischer digitaler Infrastrukturen zur Überwindung der Abhängigkeit von US-amerikanischen und chinesischen Tech-Konzernen.

**Demokratische KI-Governance**: Erarbeitung von partizipativen Governance-Frameworks für transparenten, klimaschonenden und grundrechtskonformen Einsatz von KI im öffentlichen Sektor.

**Digitale Demokratie 2.0**: Radikale Stärkung von Bürger:innenbeteiligung durch innovative digitale Werkzeuge – von Liquid Democracy bis zu algorithmus-auditierten Partizipationsplattformen.

**Resiliente Digitalisierung**: Entwicklung von Strategien für sichere, nachhaltige IT-Infrastrukturen und Green Coding Practices in der öffentlichen Verwaltung.
...
Unser Ziel: Die digitale Lebenswelt vom Menschen her zu gestalten, in den Kommunen zu verankern und europäisch zu vernetzen.
