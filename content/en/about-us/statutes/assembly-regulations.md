...
1. The Head of Assembly shall be responsible for:
   1. opening, chairing and closing the Assembly;
   1. verification of the proper convening and quorum;
   1. an announcement of the agenda and any additions thereto;
   1. the issuing and withdrawal of the word;
   1. the conduct of votes and elections;
...
1. The minutes shall contain:
   1. The place, date, start and end of the meeting;
   1. The form of the meeting (presence, virtual or hybrid);
   1. Number of voting members appearing;
   1. Names of the management of the meeting and of the minutes;
   1. the items on the agenda;
   1. the wording of the forms of order sought;
   1. Type of vote or election (open/secret);
   1. the results of the vote (in favour, against and abstentions);
   1. the text of the decisions taken;
   1. Election results.
...
1. Amendments to these requests may be tabled at any time during the deliberations. They are always admissible and do not require any specific justification. Amendments to be voted before the main request.
1. Motions for the Rules of Procedure may be made at any time and shall be dealt with immediately. These include, in particular, applications for:
   1. Closing the debate;
   1. Closing the list of speeches;
   1. Postponement of an item on the agenda;
   1. Interruption of the Assembly;
   1. secret ballot.
